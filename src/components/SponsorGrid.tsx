...
const SponsorGrid = () => {
  return (
    <>
      ...
      <div className="hidden xl:grid grid-cols-5 grid-rows-3 gap-1.5 p-4 mt-8 lg:mt-12">
        {/* MLH. Bronze */}
        <a
      ...
      <div className="lg:hidden hidden md:grid grid-cols-4 grid-rows-[150px_150px_150px] gap-1.5 p-4">
        {/* OUCU. Gold */}
        <a
          href={sponsors[1].link}
          className="p-2 col-span-4 row-span-1 bg-offWhite ring-2 ring-primary flex items-center justify-center rounded-md hover:from-[#D4AF37]/80 hover:via-[#D4AF37]/40 hover:to-[#D4AF37]/80 hover:bg-gradient-to-bl"
        >
          <img
            src={`${sponsors[1].logo}`}
            alt={`${sponsors[1].name} Logo`}
            className="w-[12rem] overflow-hidden"
          />
        </a>
      ...
      <div className="md:hidden grid grid-cols-4 grid-rows-[125px_125px_125px] gap-1.5 p-4">
        {/* OUCU. Gold */}
        <a
          href={sponsors[1].link}
          className="p-2 col-span-4 row-span-1 bg-offWhite ring-2 ring-primary flex items-center justify-center rounded-md hover:from-[#D4AF37]/80 hover:via-[#D4AF37]/40 hover:to-[#D4AF37]/80 hover:bg-gradient-to-bl"
