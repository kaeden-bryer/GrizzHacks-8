  ...
  return (
    <>
      ...
      <div className="hidden xl:grid grid-cols-5 grid-rows-5 gap-1.5 p-4">
        ...
        {/* Center */}
        <div className="md:p-4 p-2 col-span-1 row-span-1 bg-neutral-950/80 ring-1 ring-neutral-800/30 flex items-center justify-center rounded-md from-primary/80 via-primaryBlueStart/80 to-primaryBlueEnd/80 bg-gradient-to-bl">
      ...
      {/* SMALL SCREEN SIZE */}
        <div className="flex xl:hidden flex-col gap-2">
            ...
            <div className="grid grid-cols-2 gap-2 w-full">
                <a
                    href={sponsors[2].link}
                    className="max-h-[200px] col-span-1 p-6 bg-neutral-950/80 ring-1 ring-neutral-800/30 flex items-center justify-center rounded-md hover:from-[#C0C0C0]/30 hover:via-[#C0C0C0]/70 hover:to-[#C0C0C0]/30 hover:bg-gradient-to-bl"
                >
                    <img src=
                {`${sponsors[2].logo}`}
